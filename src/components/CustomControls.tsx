        ...
        <Col className="mt-4 mt-md-0" lg="3" sm="6">
          ...
          <div className="input-slider-container">
            ...
            <Row className="mt-3 d-none">
              <Col xs="6">
                <span className="range-slider-value">{simpleValue}</span>
              </Col>
            </Row>
          </div>
          {/* Range slider */}
          <div className="mt-5">
            ...
            <Row className="d-none">
              <Col xs="6">
                <span className="range-slider-value value-low">{rangeLow}</span>
              </Col>
